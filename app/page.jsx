...
export default function Page() {
  ...
  const handleGenerate = () => setResult(buildResult());
      ...
      <div className="max-w-md mx-auto bg-white rounded-[28px] shadow-sm border border-neutral-200 overflow-hidden">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full mt-2 rounded-2xl bg-black text-white py-3.5 text-base font-semibold hover:opacity-90 transition"
          >
            开始判断
          </button>
        </div>
            ...
            <div className={`rounded-[24px] p-5 border ${MODE_META[result.mode].bg} ${MODE_META[result.mode].border}`}>
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2 flex-wrap mb-2">
                  {result.recommend.map((item) => (
                    <span
                      key={item}
                      className="text-sm px-3 py-1.5 rounded-full bg-white border border-neutral-300 text-neutral-900"
                    >
                      {item}
                    </span>
                  ))}
              ...
              {result.planB && (
                <div className="mb-4">
                  ...
                  <div className="inline-flex text-sm px-3 py-1.5 rounded-full bg-white border border-neutral-300 text-neutral-900">
                    {result.planB}
                  </div>
                </div>
              )}
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  {result.avoid.map((item) => (
                    <span
                      key={item}
                      className="text-sm px-3 py-1.5 rounded-full bg-neutral-100 border border-neutral-200 text-neutral-500"
                    >
                      {item}
                    </span>
                  ))}
